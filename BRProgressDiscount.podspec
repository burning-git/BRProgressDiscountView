...
#  s.description      = <<
  ...
  s.homepage         = 'https://github.com/burning_git@163.com/BRProgressDiscount'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'burning_git@163.com' => 'burning_git@163.com' }
  s.source           = { :git => 'https://github.com/burning_git@163.com/BRProgressDiscount.git', :tag => s.version.to_s }
